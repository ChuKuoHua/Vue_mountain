<template>
  <div>
    ...
    <div class="container about-content my-4 px-0">
      ...
      <div class="col-md-6 right-content-box">
        <p class="right-content">
          我們是一群熱愛登山的登山員，完成數座百岳山，擁有相當豐富的登山經歷；
          不僅提供專業的諮詢服務，同時精選世界各地的優質商品，以專業、服務、品質為三大核心理念。
          創立 <span class="font-weight-bolder">MOUNTAIN</span> 不僅是讓消費者選到適合的商品，也期望變成熱愛登山的同好，共同交流彼此的經歷。
        </p>
      </div>
    </div>
